...
def process_person(person_origin):
...
while True:
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        futures = [executor.submit(process_person, person_origin) for person_origin in cod_ref_persons]
    ...
    if step == 1:
        ...
        insert_bd_persons_migration_history = bd.insert_date_persons_migration_history(clients_data.person_type, top, skip, page, url)
        skip += top
        page += 1
